...
import com.wwp.QA.ProductionLine.ProductionlineResponse;
...
public interface ProductionoperatorApi {
    ...
    //
    @POST("//{webaddress}/pms/api/productionoperator/")
    Call<ProductionoperatorResponse> getProductionoperatorList(
